    ...
    <>
      <div className="flex items-center justify-center relative z-30">
        <div className="flex flex-col items-center justify-center h-72 w-72 mt-12 border-solid border-2 rounded bg-white">
          <h1 className="text-8xl font-extrabold text-black tracking-widest">
            404
          </h1>
          <div>Page not found</div>
          <button
            className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 bg-green-500  h-8 w-20"
            onClick={backToLogin}
          >
            {" "}
            Back
